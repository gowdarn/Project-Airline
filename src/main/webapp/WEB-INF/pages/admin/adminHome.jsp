...
<body class="fix-header">
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<!-- Tab User info -->
			<div hidden id="tab-admin-info">
				<jsp:include page="tabAdminInfo.jsp"></jsp:include>

			</div>

			<!-- Tab User list -->
			<div hidden id="tab-user-list">
				<jsp:include page="tabAdminUser.jsp"></jsp:include>
