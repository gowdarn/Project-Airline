						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="timeStart">From</label> <input type="text"
										class="form-control" name="locationFrom" />
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="endTime">To</label> <input type="text"
										class="form-control" name="locationTo" />
								</div>
							</div>
						</div>
